...
public class UserBilling {
	...
	private String userBillingDivision;
	...
	public String getUserBillingDivision() {
		return userBillingDivision;
	}

	public void setUserBillingDivision(String userBillingDivision) {
		this.userBillingDivision = userBillingDivision;
	}
