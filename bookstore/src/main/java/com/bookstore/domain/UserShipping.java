...
public class UserShipping {
	...
	private String userShippingDivision;
	...
	public String getUserShippingDivision() {
		return userShippingDivision;
	}

	public void setUserShippingDivision(String userShippingDivision) {
		this.userShippingDivision = userShippingDivision;
	}
