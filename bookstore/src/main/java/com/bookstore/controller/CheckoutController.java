...
import com.bookstore.utility.BDConstants;
...
public class CheckoutController {
	...
	public String checkout(@RequestParam("id") Long cartId,
		...
		List<String> divList = BDConstants.listOfBDDivisionCode;
	...
	public String checkoutPost(@ModelAttribute("shippingAddress") ShippingAddress shippingAddress,
		...
		if (billingSameAsShipping.equals("true")) {
			...
			billingAddress.setBillingAddressDivision(shippingAddress.getShippingAddressDivision());
		...
		if (shippingAddress.getShippingAddressStreet1().isEmpty() || shippingAddress.getShippingAddressCity().isEmpty()
				|| shippingAddress.getShippingAddressDivision().isEmpty()
				...
				|| billingAddress.getBillingAddressCity().isEmpty() || billingAddress.getBillingAddressDivision().isEmpty()
